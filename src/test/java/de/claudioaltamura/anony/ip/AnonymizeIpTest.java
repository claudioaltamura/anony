...
class AnonymizeIpTest {
  ...
  public void testAnonymizeIpNull() throws AnonymizeException {
    assertThrows(AnonymizeException.class, () -> {
      AnonymizeIp.anonymize(null);
    });
  }
  ...
  public void testAnonymizeIpV6Address() throws AnonymizeException {
    assertEquals("2001:db8:85a3:8d3:0:0:0:0",
        AnonymizeIp.anonymize("2001:0db8:85a3:08d3:1319:8a2e:0370:7344"));
